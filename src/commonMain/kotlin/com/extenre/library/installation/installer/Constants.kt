...
internal object Constants {
    ...
    const val TMP_FILE_PATH = "/data/local/tmp/extenre.tmp"
    const val MOUNT_PATH = "/data/adb/extenre/"
    const val MOUNTED_APK_PATH = "$MOUNT_PATH$PLACEHOLDER.apk"
    const val MOUNT_SCRIPT_PATH = "/data/adb/service.d/mount_extenre_$PLACEHOLDER.sh"
