...
import com.extenre.patcher.patch.OptionException
...
object Options {
     ...
     * @param json The JSON string containing the options.
     */
    fun Set<com.extenre.patcher.patch.Patch<*>>.setOptions(json: String) {
     ...
     * @see setOptions
     */
    fun Set<com.extenre.patcher.patch.Patch<*>>.setOptions(file: File) = setOptions(file.readText())
